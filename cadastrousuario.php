    ...
    <div class="container">
        <div class="content first-content">
            <div class="first-column">
                ...
                <p class="description description-primary">Para continuar conectado com nós,</p>
        ...
        <div class="content second-content">
            <div class="first-column">
                ...
                <p class="description description-primary">e comece sua jornada musical com nós</p>
            ...
            <div class="second-column">
                ...
                <form class="form" method="post">
                    ...
                    <input type="submit" class="btn btn-second" value="Entrar">
                </form>
            </div><!-- segunda coluna -->
        </div><!-- segundo column -->
    </div>
