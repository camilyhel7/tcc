...
<body>
    <form action="#" method="post">
        <h3>Conteúdo</h2> 
        <input type="text" class="selectionbox" name="enunciado" placeholder="Descrição">
    ...
    <form action="#" method="post">
        ...
        while($row = mysqli_fetch_assoc($result)) {?>
            <option class=""  value="<?=$row['cod_conteudo']?>"><?=$row['enunciado']?></option>
            <?php } ?>
        </select>
...
if(isset($_POST['conteudo_envia'])){
    ...
    $sql = "INSERT INTO conteudo(midia, enunciado) VALUES('$midia', '$enunciado')";
    $result = mysqli_query($conn, $sql);
}
