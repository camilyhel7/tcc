            ...
            <div class="header">
                ...
                <div class="content">
                    <div class="left">
                        <div class="about-container">
                            ...
                            <p class="text">Lorem Ipsum is simply text of the print and types industry.</p>
                        </div>
                ...
                <div class="right">
                    <div>
                        ...
                        <h3 class="number-title" id="fa-solid fa-star"> Nível</h3>
                    </div>
                    
                    <div>
                        <h3 class="number">300</h3>
                        <h3 class="number-title">Pontos</h3>
                    </div>
                    <div>
                        <h3 class="number">30</h3>
                        <h3 class="number-title">tatat</h3>
                    </div>
                </div>
            </div>
        </div>
